...
@system_manager_api.route('/user_manager/all_user', methods=('get',))
@jwt_required()
def all_user():
    """所有的用户信息
    获取系统的所有用户信息，
    ...
    ---
    tags:
      - system_manager_api/user_manager
    responses:
      200:
...
@system_manager_api.route('/user_manager/add_user', methods=('post',))
@jwt_required()
@logit()
def add_user():
    """添加用户信息
...
@system_manager_api.route('/user_manager/edit_user', methods=('post',))
@jwt_required()
@logit()
def edit_user():
    """编辑更新用户项信息
...
@system_manager_api.route('/user_manager/delete_user', methods=('post',))
@jwt_required()
@logit()
def delete_user():
    """删除用户信息
...
@system_manager_api.route('/user_manager/user_by_role', methods=('post',))
@jwt_required()
def user_by_role():
    """获取用户对应的角色信息
    获取用户对应的角色信息
...
@system_manager_api.route('/user_manager/save_user_by_role', methods=('post',))
@jwt_required()
@logit()
